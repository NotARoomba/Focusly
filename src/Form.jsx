...
export default function Form() {
  ...
  const variants = {
    ...
    visible: { opacity: 1, display: 'flex', transition: { duration: 0.75, delay: 1} }
  };
    ...
    <html>
      ...
      >
        ...
        style={{ 'display': 'none' }}
          ...
          initial="hidden">
            ...
            <div className="paragraphs">
              <input type="radio" value="bionic" name="fashion" id="bionic" />
              <label htmlFor="bionic" className="border-2 border-black rounded">
                <img src="/src/bionic.png"></img>
              </label>

              <input type="radio" value="nobionic" name="fashion" id="nobionic" />
        ...
        style={{ 'display': 'none' }}
          ...
          initial="hidden">
            ...
            <div className="paragraphs">
              <input type="radio" value="read" name="fashion2" id="read" />
              <label htmlFor="read" className="border-2 border-black rounded-full">
                Reading
              </label>

              <input type="radio" value="watch" name="fashion2" id="watch" />
      ...
      <motion.div className="section" id="section-7" variants={variants}
        style={{ 'display': 'none' }}
          ...
          initial="hidden">
            ...
            <input type="radio" value="pink" name="colors" id="pink" />
      ...
      <motion.div className="section" id="section-8" variants={variants}
            ...
            <ul className="items-center w-full text-sm font-medium text-black bg-white border border-gray-300 rounded-lg sm:flex dark:bg-gray-200 dark:border-gray-300 dark:text-white">
              <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-300">
                <div className="flex items-center pl-3">
                  ...
                  <label for="painting" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-black">Gardening</label>
                </div>
              </li>
              ...
              <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-300">
                <div className="flex items-center pl-3">
                  ...
                  <label for="videogames" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-black">Cooking</label>
                </div>
              </li>
              ...
              <li className="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-300">
                <div className="flex items-center pl-3">
                  ...
                  <label for="music" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-black">Sports</label>
                </div>
              </li>
              ...
              <li className="w-full dark:border-gray-600">
                <div className="flex items-center pl-3">
                  ...
                  <label for="fashion" className="w-full py-3 ml-2 text-sm font-medium text-gray-900 dark:text-black">Reading</label>
                </div>
              </li>
            </ul>
          </div>
        ...
        {/* SECTION 8 STARTSS */}
          ...
          <button type="submit" className="transition-all duration-500 bg-neutral-900 hover:bg-neutral-600 text-white font-bold button rounded-full mt-10	" onClick={next}>Next</button>
  ...
  function next() {
    ...
    if (section != 8) {
      ...
      eval('section' + section).start('hidden')
      if (section !=1) {
        const sectionPrev = document.getElementById("section-" + (section - 1))
